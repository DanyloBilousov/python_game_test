...
def create_bonus():
    bonus_size = (10, 10)
    bonus = pygame.transform.scale(pygame.image.load('bonus.png').convert_alpha(), (130, 200))
...
def create_enemy():
    enemy_size = (30, 30)
    enemy = pygame.transform.scale(pygame.image.load('enemy.png').convert_alpha(), (130, 50))
